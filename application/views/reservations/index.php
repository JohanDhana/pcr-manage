<div class="container">
	...
	<div class="row py-2 d-flex justify-content-center">
						...
						<tr>
							...
							<td>
								<?php if ($reservation['payment_status'] == 1) { ?>
									...
									<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#198754" class="bi bi-check2-circle" viewBox="0 0 16 16">
		...
		<div class="col-lg-6 col-md-8 p-0">
			<img src="<?= base_url('/assets/images/tests/' . $event['image']) ?>" style="width: 100%; max-height:350px; object-fit:cover;" />
		</div>
	</div>
</div>