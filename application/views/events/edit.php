<div class="row pt-5">
  <div class="col-md-6 offset-md-3 event-form">
    ...
    <?php echo form_open_multipart('tests/update/' . $event['idtests'], ['id' => 'requestForm']); ?>
    ...
    <div class="mb-3">
      <img src="<?= base_url('assets/images/tests/' . $event['image']) ?>" class="card-img" style="height: 80px;object-fit: cover;width: 150px;" alt="..."></td>
    </div>

    <button type="submit" class="btn btn-primary">Submit</button>
    </form>
    <?php echo form_open_multipart('tests/thank-email/' . $event['testsId'], ['id' => 'requestForm']); ?>
    <input type="hidden" name="event_id" value="<?= $event['testsId'] ?>">
